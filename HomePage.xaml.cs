...
namespace skininjector_v2
{
    ...
    public sealed partial class HomePage : Page
    {
        ...
        private Boolean isPreviewLegacy = false;
        private Boolean isMinecraftLegacy = false;
        private ContentDialog? _currentDialog;

        private Boolean isPathSelected = false;
        private Boolean isTargetPackSelected = false;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Injector.OnProgress += UpDateProgress;
            UpdateSkinPackList();
        ...
        private void PackItem_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            var deleteItem = new MenuFlyoutItem { Text = "元のスキンデータを復元" };
        ...
        private void DeleteSkinData(object sender, RoutedEventArgs e)
        {
            ...
            if (packInfo == null)
            {
                this.ShowErrorMsg("復元するスキンパックが選択されていません。");
                return;
            }
            string? targetPath = packInfo.FolderPath;
            if (targetPath == null)
            {
                this.ShowErrorMsg("復元するスキンパックのパスが存在しません。");
                return;
            }
            else
            {
        ...
        private void InjectHistoryButton_Click(object sender, RoutedEventArgs e)
        {
